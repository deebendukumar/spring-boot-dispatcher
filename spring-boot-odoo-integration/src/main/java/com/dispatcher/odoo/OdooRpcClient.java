 ...
 */
public class OdooRpcClient extends XmlRpcClient {
	 ...
	 */
	public OdooRpcClient(RPCProtocol protocol, String host, int port, RPCServices service) {
		super();
	...
	/***
	 * Configures the XML-RPC client to use a Proxy if the system properties are
	 * set.
	 * 
	 * @param protocol
	 *            Protocol to use when connecting to the RPC service ex.
