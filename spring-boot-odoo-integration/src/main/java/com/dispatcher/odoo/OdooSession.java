...
public class OdooSession {
    ...
    private static final Logger logger = LoggerFactory.getLogger(OdooSession.class);
    ...
    private int userID;
    private OdooContext context = new OdooContext();
     ...
     */
    public OdooSession(RPCProtocol protocol, String host, int port, String databaseName, String userName, String password) {
     ...
     * @param password     Password to log into the Odoo server
     */
    public OdooSession(String host, int port, String databaseName, String userName, String password) {
     ...
     */
    public OdooReportAdapter getReportAdapter(String reportName) throws OdooApiException, XmlRpcException {
        OdooReportAdapter reportAdapter = new OdooReportAdapter(this);
    ...
    public Object executeCommandKw(final String objectName, final String commandName, final Object[] parameters,
                                   OdooContext context) throws XmlRpcException {
        ...
        Map<String, OdooContext> c = new HashMap<>();
