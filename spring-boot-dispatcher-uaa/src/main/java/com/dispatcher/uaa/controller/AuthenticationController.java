...
public class AuthenticationController extends AbstractWebController {
    ...
    @Operation(summary = "")
    public LogoutResponse logout(@Valid @RequestBody LogoutResponse logoutResponse,
                                 HttpServletRequest httpServletRequest,
                                 HttpServletResponse httpServletResponse) {
        return null;
    }
    ...
    @Operation(summary = "")
    public ForgotPasswordResponse forgotPassword(@Valid @RequestBody ForgotPasswordRequest forgotPasswordRequest,
                                                 HttpServletRequest httpServletRequest,
                                                 HttpServletResponse httpServletResponse) {
        return null;
    }
