...
@RestController
@RequestMapping("/hazard-classes")
@Tag(name = "Authentication", description = "")
public class HazardClassficationController extends AbstractWebController {

    private static final Logger logger = LoggerFactory.getLogger(HazardClassficationController.class);

    HazardClassficationController() {
    }
