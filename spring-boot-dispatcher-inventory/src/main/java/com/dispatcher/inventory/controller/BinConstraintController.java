...
@RestController
@RequestMapping("/bin-constraints")
@Tag(name = "Authentication", description = "")
public class BinConstraintController extends AbstractWebController {

    private static final Logger logger = LoggerFactory.getLogger(BinConstraintController.class);

    BinConstraintController() {
    }
