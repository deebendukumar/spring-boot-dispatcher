...
public class ReorderRulesController extends AbstractWebController {

    private static final Logger logger = LoggerFactory.getLogger(ReorderRulesController.class);
    ...
    @Operation(summary = "")
    public LocationResponse trigger(@PathVariable String id,
                                     HttpServletRequest httpServletRequest,
                                     HttpServletResponse httpServletResponse) {
        return null;
    }
