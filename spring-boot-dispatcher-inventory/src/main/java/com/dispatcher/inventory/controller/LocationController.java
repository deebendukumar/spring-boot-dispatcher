...
public class LocationController extends AbstractWebController {
    ...
    @Operation(summary = "")
    public LocationResponse bulkCreate(@Valid @RequestBody LocationRequest locationRequest,
                                   HttpServletRequest httpServletRequest,
                                   HttpServletResponse httpServletResponse) {
        return null;
    }
    ...
    @Operation(summary = "")
    public LocationResponse bulkImport(@Valid @RequestBody LocationRequest locationRequest,
                                       HttpServletRequest httpServletRequest,
                                       HttpServletResponse httpServletResponse) {
        return null;
    }
    ...
    @Operation(summary = "")
    public LocationResponse generate(@Valid @RequestBody LocationRequest locationRequest,
                                       HttpServletRequest httpServletRequest,
                                       HttpServletResponse httpServletResponse) {
        return null;
    }
    ...
    @Operation(summary = "")
    public LocationResponse children(@PathVariable String id,
                                     HttpServletRequest httpServletRequest,
                                     HttpServletResponse httpServletResponse) {
        return null;
    }
    ...
    @Operation(summary = "")
    public LocationResponse inventory(@PathVariable String id,
                                     HttpServletRequest httpServletRequest,
                                     HttpServletResponse httpServletResponse) {
        return null;
    }
    ...
    @Operation(summary = "")
    public LocationResponse validate(@PathVariable String id,
                                      HttpServletRequest httpServletRequest,
                                      HttpServletResponse httpServletResponse) {
        return null;
    }
