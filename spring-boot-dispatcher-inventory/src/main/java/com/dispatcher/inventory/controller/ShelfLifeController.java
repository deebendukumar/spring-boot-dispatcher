...
@RestController
@RequestMapping("/shelf-life")
@Tag(name = "Authentication", description = "")
public class ShelfLifeController extends AbstractWebController {

    private static final Logger logger = LoggerFactory.getLogger(ShelfLifeController.class);
