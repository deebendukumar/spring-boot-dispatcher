...
public class Result<T extends Serializable> extends RepresentationModel<Result<T>> implements Serializable {
    ...
    /**
     * An array ob objects that can be passed to the client to identify failure
     * items.
     */
    private T[] obj;
    ...
    /**
     * Checks whether all mandatory fields are set on the String passed as
     * {@literal s} and parses this String into a
     * valid instance.
     *
    ...
    public static <T extends Serializable> Result<T> parse(String s) throws ParseException {
        if (s.contains("message") &&
            ...
            var r = new Result<>(JsonPath.read(d, "$.message"), JsonPath.read(d, "$.messageKey"),
                    JsonPath.read(d, "$.httpStatus"), obj);
            r.any();
        }
    ...
    public boolean equals(Object o) {
        ...
        if (httpStatus != null ? !httpStatus.equals(response.httpStatus) : response.httpStatus != null)
            return false;
        if (message != null ? !message.equals(response.message) : response.message != null)
            return false;
        if (messageKey != null ? !messageKey.equals(response.messageKey) : response.messageKey != null)
            return false;
    ...
    public static final class Builder<T extends Serializable> {
        ...
        /**
         * Sets the {@code message} and returns a reference to this Builder so that the
        ...
        /**
         * Sets the {@code messageKey} and returns a reference to this Builder so that
        ...
        /**
         * Sets the {@code obj} and returns a reference to this Builder so that the
        ...
        /**
         * Sets the {@code httpStatus} and returns a reference to this Builder so that
         * the methods can be chained
         * together.
         *
         ...
         *
         * @return a {@code Response} built with parameters of this
