...
package com.dispatcher.adapters.odoo.helpers;

import com.dispatcher.adapters.odoo.OdooField;
import com.dispatcher.adapters.odoo.OdooFieldCollection;
 ...
 * }
 */
public class OdooFlatViewHelper {
     ...
     */
    public static FlatViewFieldCollection getFields(String objectName, OdooFieldCollection fields) throws XmlRpcException {
        ...
        for (OdooField fld : fields) {
            ...
            OdooField.FieldType fieldType = fld.getType();
            switch (fieldType) {
                case BINARY:
     ...
     * @throws XmlRpcException
     */
    public static String[] getFieldNames(String objectName, OdooFieldCollection fields) throws XmlRpcException {
     ...
     */
    public static Object getRowValue(OdooRow row, FlatViewField fld) {
        Object value;
    ...
    public static class FlatViewField {
        ...
        private final OdooField sourceField;
         ...
         */
        protected FlatViewField(String uniqueID, OdooField sourceField, int sourceFieldIndex, String relatedModel, String name, String label, Class<?> type) {
        ...
        public OdooField getSourceField() {
            return sourceField;
        }
