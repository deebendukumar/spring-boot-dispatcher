...
public class OdooCountryApiClient extends OdooApiClient {

    private static final Logger logger = LoggerFactory.getLogger(OdooCountryApiClient.class);

    private static final String _MODEL = "res.country";

    public OdooCountryApiClient(OdooSession session) throws XmlRpcException, OdooApiException {
