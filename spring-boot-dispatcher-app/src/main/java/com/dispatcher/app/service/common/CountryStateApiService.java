...
import com.dispatcher.odoo.facade.OdooCountryStateApiClient;
 ...
 */
@TxService
public class CountryStateApiService {
    ...
    CountryStateApiService(Environment environment, Translator translator, OdooSession session) {
